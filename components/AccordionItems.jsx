        ...
        <>
            {subMenu.map((item) => (
                ...
                >
                    ...
                    <div
                        className={`z-10 text-lg bg-gray-400 transition-all -translate-y-full flex flex-col items-end justify-end ${
                    ...
                    >
                        {item.name === activeIndex && (
                            <>
                                {item.children[0] ? (
                                    <SubAccordion subMenu={item.children} />
                                ) : (
